  ...
  $(window).scroll(function() {
    ...
    if (scroll > position2) {
      if (screen.width<600){
        ...
        $("#iddv_flotante_new").css("margin-top","-36vh");
      ...
      if (screen.width<600) {
        ...
        $("#iddv_flotante_new").css("margin-top","-12vh");
      }
      else {
        $("#iddv_flotante_new").css("position","absolute");
...
function EscuelaLista(){
    ...
    this.getEscuelas_1 = function(){
      ...
      var ruta = base_url+"escuela/getEscuelas";
      $.ajax({
        url: ruta,
        method: 'POST',
    ...
    this.getTurnoCCT = function(cct){
      ...
      if(RE_CCT(cct)){
          ...
          .done(function( data ) {
              ...
              if($('#LE_cct_turno option').length == 1){
                  tmp_EL.getEscuelasCCT();
              }
