...
<table class="table table-striped table-hover">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">11</th>
      <td>Acta de Visita de Inspección Inicial (Nivel Primaria)
    ...
    <tr>
      <th scope="row">12</th>
      <td>Acta de Visita de Inspección Inicial (Nivel Secundaria General)
    ...
    <tr>
      <th scope="row">13</th>
      <td>Acta de Visita de Inspección Inicial (Nivel Secundaria Técnica)
    ...
    <tr>
      <th scope="row">15</th>
      <td>Acta de Visita de Inspección Inicial Capacitación para el Trabajo, Técnico y Técnico Profesional
  ...
  <div class="card">
    <div class="card-header collapsed" id="heading2" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapse2" style="cursor: pointer;">
       <i class="fas fa-clipboard-list mr-2"></i> <span class="text-primary">Altas y Bajas Recientes</span>
    </div>
...
<table class="table table-striped table-hover">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">12</th>
      <td>Instituciones que obtuvieron RVOE
    ...
    <tr>
      <th scope="row">13</th>
      <td>Instituciones Sancionadas 2016-2017
    ...
    <tr>
      <th scope="row">15</th>
      <td>Resolucion Administrativa COLEGIO JUAN DE LA CRUZ 21112017
  ...
  <div class="card">
    <div class="card-header collapsed" id="heading3" data-toggle="collapse" data-target="#collapse3" aria-expanded="false" aria-controls="collapse3" style="cursor: pointer;">
       <i class="fas fa-clipboard-list mr-2"></i> <span class="text-primary">Comunicados</span>
    </div>
...
<table class="table table-striped table-hover">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">11</th>
      <td>Oficio - Segundo Requerimiento Supervisor
  ...
  <div class="card">
    <div class="card-header collapsed" id="heading4" data-toggle="collapse" data-target="#collapse4" aria-expanded="false" aria-controls="collapse4" style="cursor: pointer;">
       <i class="fas fa-clipboard-list mr-2"></i> <span class="text-primary">Modelo Educativo 2016</span>
    </div>
...
<table class="table table-striped table-hover">
  ...
  <div class="card">
    <div class="card-header collapsed" id="heading5" data-toggle="collapse" data-target="#collapse5" aria-expanded="false" aria-controls="collapse5" style="cursor: pointer;">
       <i class="fas fa-clipboard-list mr-2"></i> <span class="text-primary">Normatividad</span>
    </div>
...
<table class="table table-striped table-hover">
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td>Comercialización de servicios educativos y pagos de derechos</td>
      <td>2</td>
      <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalComercializacion">
  <i class="fa fa-folder-open" aria-hidden="true"></i>
    ...
    <tr>
      ...
      <td>7</td>
      <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalBasica">
  <i class="fa fa-folder-open" aria-hidden="true"></i>
</button></td>
    </tr>
    <tr>
      ...
      <td>3</td>
      <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalInicial">
  <i class="fa fa-folder-open" aria-hidden="true"></i>
</button></td>
    </tr>
    <tr>
      ...
      <td>Generales</td>
      <td>4</td>
      <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalGenerales">
  <i class="fa fa-folder-open" aria-hidden="true"></i>
</button></td>
    </tr>
    <tr>
      <th scope="row">5</th>
      <td>Normatividad Media Superior</td>
      <td>12</td>
      <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalMS">
  <i class="fa fa-folder-open" aria-hidden="true"></i>
</button></td>
    </tr>
  ...
  <div class="card">
    <div class="card-header collapsed" id="heading6" data-toggle="collapse" data-target="#collapse6" aria-expanded="false" aria-controls="collapse6" style="cursor: pointer;">
       <i class="fas fa-clipboard-list mr-2"></i> <span class="text-primary">Trámites Específicos</span>
    </div>
...
<table class="table table-striped table-hover">
  ...
  <div class="card">
    <div class="card-header collapsed" id="heading7" data-toggle="collapse" data-target="#collapse7" aria-expanded="false" aria-controls="collapse7" style="cursor: pointer;">
       <i class="fas fa-clipboard-list mr-2"></i> <span class="text-primary">Otros</span>
    </div>
